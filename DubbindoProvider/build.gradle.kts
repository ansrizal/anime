...
cloudstream {
    ...
    description = "CloudStream 3 streaming provider extension module for DubbindoProvider"
}

android {
    namespace = "com.ansrizal.anime.dubbindoprovider"
    compileSdk = 34
    ...
    defaultConfig {
        buildConfigField("String", "DUBBINDO_USERNAME", "\"\"")
        buildConfigField("String", "DUBBINDO_PASSWORD", "\"\"")
    }
}
